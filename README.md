...
In this tab, tasks with priority equal to 1 are allowed.
...
* Quando o usuário arrastar o card principal para baixo, um temporizador aparecerá. Ao apertar o ícone play, o temporizador de 30 minutos será
